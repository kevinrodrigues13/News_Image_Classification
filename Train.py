...
from Support import ProtestDataset, modified_resnet50, AverageMeter, Lighting
...
if _name_ == "_main_":
    ...
    parser.add_argument("--data_dir",
                        type=str,
                        default = "AiProject/",
                        help = "directory path to dataset for testing",
                        )
    ...
    parser.add_argument('--resume',
                        default='checkpoint.pth.tar', type=str, metavar='PATH',
